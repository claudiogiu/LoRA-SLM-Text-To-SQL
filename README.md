...
- This command sequentially performs the following operations:
  ...
  - Loads the WikiSQL dataset and formats it into Hugging Face Dataset objects for the subsequent fine‑tuning and evaluation stages.
  - Performs parameter‑efficient fine‑tuning of T5, Qwen2.5, and Llama 3.x models via LoRA, storing the resulting adapters in the `models/` directory.
